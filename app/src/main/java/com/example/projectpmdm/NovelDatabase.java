...
public class NovelDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        try {
            ...
            db.execSQL("INSERT INTO chapters (date,url,idSeries) VALUES('" + Calendar.getInstance().getTime().toString() + "','https://www.lightnovelpub.com/novel/my-house-of-horrors-305/chapter-1',2)");
            db.execSQL("INSERT INTO chapters (date,url,idSeries) VALUES('" + Calendar.getInstance().getTime().toString() + "','https://www.lightnovelpub.com/novel/my-house-of-horrors-305/chapter-2',2)");
            db.execSQL("INSERT INTO chapters (date,url,idSeries) VALUES('" + Calendar.getInstance().getTime().toString() + "','https://www.lightnovelpub.com/novel/my-house-of-horrors-305/chapter-3',2)");
            db.execSQL("INSERT INTO chapters (date,url,idSeries) VALUES('" + Calendar.getInstance().getTime().toString() + "','https://www.lightnovelpub.com/novel/my-house-of-horrors-305/chapter-4',2)");
            db.execSQL("INSERT INTO chapters (date,url,idSeries) VALUES('" + Calendar.getInstance().getTime().toString() + "','https://www.lightnovelpub.com/novel/my-house-of-horrors-305/chapter-5',2)");

            db.execSQL("INSERT INTO chapters (date,url,idSeries) VALUES('" + Calendar.getInstance().getTime().toString() + "','https://www.lightnovelpub.com/novel/i-shall-seal-the-heavens-225/chapter-1',3)");
            db.execSQL("INSERT INTO chapters (date,url,idSeries) VALUES('" + Calendar.getInstance().getTime().toString() + "','https://www.lightnovelpub.com/novel/i-shall-seal-the-heavens-225/chapter-2',3)");

            db.execSQL("INSERT INTO chapters (date,url,idSeries) VALUES('" + Calendar.getInstance().getTime().toString() + "','https://www.webnovel.com/book/lord-of-mysteries-2-circle-of-inevitability_25759730405792805/foreigners_69219458274610268',4)");

            db.execSQL("INSERT INTO chapters (date,url,idSeries) VALUES('" + Calendar.getInstance().getTime().toString() + "','https://starrynightnovels.com/2018/05/18/chapter-1-spring-palace-part-one/',5)");

            db.execSQL("INSERT INTO chapters (date,url,idSeries) VALUES('" + Calendar.getInstance().getTime().toString() + "','https://enxiao.wordpress.com/2017/01/08/founder-of-diabolism-chapter-3/',6)");

            db.execSQL("INSERT INTO chapters (date,url,idSeries) VALUES('" + Calendar.getInstance().getTime().toString() + "','https://www.novelmultiverse.com/novel/volcanic-age/chapter-1/',7)");

            db.execSQL("INSERT INTO chapters (date,url,idSeries) VALUES('" + Calendar.getInstance().getTime().toString() + "','https://www.wuxiaworld.com/novel/martial-world/mw-chapter-1',8)");
